...
//        garage.workplaces.add(new Workplace("Workplace1", List.of(
//                new TimeInterval(
...
//                        LocalDateTime.of(2025, 11, 14, 17, 0)
//                ))));
//        garage.workplaces.add(new Workplace("Workplace2", List.of(new TimeInterval(
//                LocalDateTime.of(2025, 11, 11, 8, 0),
//                LocalDateTime.of(2025, 11, 11, 17, 0)
//        ))));
//
//        garage.workplaces.add(new Workplace("Workplace3", List.of(new TimeInterval(
//                LocalDateTime.of(2025, 11, 13, 8, 0),
//                LocalDateTime.of(2025, 11, 13, 17, 0)
//        ))));
//
...
//        garage.rescheduleOrder(idToReschedule, new TimeInterval(
//                LocalDateTime.of(2025, 11, 14, 7, 0),
...
//            System.out.println(order.name + " " + order.price + " " + order.status + " " + order.timeInterval.show());
//        }
//
//        System.out.println("\nСписок мастеров");
...
//        List<Order> deletedOrders = garage.currentOrdersList(
//                OrderStatus.DELETED,
//                new TimeInterval(
...
//    }
    ...
    public static void main(String[] args) {
        GarageManager gm = GarageManager.Singleton();
